...
function createTestEvent(): Event {
  return {
    ...
    afterparty_door_code: null,
    afterparty_byob: null,
    afterparty_notes: null,
    afterparty_hosts: null,
    host_self_messages: null,
    lips_sealed_messages: null,
    mystery_host_messages: null,
    enabled_awards: null,
